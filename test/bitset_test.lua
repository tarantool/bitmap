...
g.test_new_from_tuple = function()
    ...
    local bs2 = bitmap.new_from_tuple(bs1_tuple, 2)
...
g.test_bor_uint_keys = function()
    ...
    local result = bitmap.bor_uint_keys(box.space.space1.id, 0, 2, { 3, 4 })
...
g.test_band_uint_keys = function()
    ...
    local result = bitmap.band_uint_keys(box.space.space1.id, 0, 2, { 5, 6 })
    t.assert_equals(result:to_string(), expected)
end
...
g.test_bxor_uint_keys = function()
    ...
    local result = bitmap.bxor_uint_keys(box.space.space1.id, 0, 2, { 7, 8 })
    t.assert_equals(result:to_string(), expected)
end

g.test_count = function()
    local bs = bitmap.new_from_string('\xFF\x00\xFF\x00\xFF\x00\x00\x00')
    t.assert_equals(bs:count(), 24)
end

g.test_all = function()
    t.assert_equals(bitmap.new_from_string('\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF'):all(), true)
    t.assert_equals(bitmap.new_from_string('\xFF\x00\xFF\x00\xFF\x00\x00\x00'):all(), false)
end

g.test_none = function()
    t.assert_equals(bitmap.new_from_string('\x00\x00\x00\x00\x00\x00\x00\x00'):none(), true)
    t.assert_equals(bitmap.new_from_string('\xFF\x00\xFF\x00\xFF\x00\x00\x00'):none(), false)
end

g.test_any = function()
    t.assert_equals(bitmap.new_from_string('\x00\x00\x00\x00\x00\x00\x00\x00'):any(), false)
    t.assert_equals(bitmap.new_from_string('\xFF\x00\xFF\x00\xFF\x00\x00\x00'):any(), true)
end
...
g.test_get_set_bit = function()
    local bs = bitmap.new_from_string('\x00\x00\x00\x00\xFF\xFF\xFF\xFF')
...
g.test_set_bit_in_tuple_uint_key = function()
    ...
    t.assert_equals(bitmap.new_from_tuple(tuple, field_no):get_bit(1), false)
    t.assert_equals(bitmap.new_from_tuple(tuple, field_no):get_bit(64), true)

    bitmap.set_bit_in_tuple_uint_key(box.space.space1.id, index_id, id, field_no, 1, true)
    tuple = box.space.space1:get(id)
    t.assert_equals(bitmap.new_from_tuple(tuple, field_no):get_bit(1), true)

    bitmap.set_bit_in_tuple_uint_key(box.space.space1.id, index_id, id, field_no, 64, false)
    tuple = box.space.space1:get(id)
    t.assert_equals(bitmap.new_from_tuple(tuple, field_no):get_bit(64), false)
end
...
g.test_bor_uint_iter = function()
    ...
    local result = bitmap.bor_uint_iter(box.space.space2.id, box.space.space2.index.secondary.id,
            1, 3, box.index.EQ)
    t.assert_equals(result:to_string(), expected)
end
...
g.test_band_uint_iter = function()
    ...
    local result = bitmap.band_uint_iter(box.space.space2.id, box.space.space2.index.secondary.id,
            2, 3, box.index.EQ)
    t.assert_equals(result:to_string(), expected)
end
...
g.test_bxor_uint_iter = function()
    ...
    local result = bitmap.bxor_uint_iter(box.space.space2.id, box.space.space2.index.secondary.id,
            3, 3, box.index.EQ)
    t.assert_equals(result:to_string(), expected)
end
